...
public class UrlValidatorTest extends TestCase {
    ...
    //Post Testing
    @Test
	public void testYourThirdPartition() throws Throwable {
		UrlValidator urlVal = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);
		System.out.println("\nPort Testing");
		//expectation: true
    ...
    //Path Testing
    @Test
	public void testYourFourthPartition() throws Throwable {
		UrlValidator urlVal = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);
		System.out.println("\nPath Testing");
		//expectation: true
    ...
    //Query Testing
    @Test
	public void testYourFifthPartition() throws Throwable {
		UrlValidator urlVal = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);
		System.out.println("\nQuery Testing");
		//expectation: true
	...
	String generateURL() {
		...
		final String[] schemes = {"http", "https", "ftp", "", "htp", null};
		final String[] tlds = {"com", "gov", "org", "", "edu", "zog", null};
		final String[] names = {"yahoo.", "", "a.", "123.", "google.", null};
